...
restaurants = [{'type': 'unica', 'title':'Assarin', 'link': 'http://www.unica.fi/fi/ravintolat/assarin-ullakko/', 'thumb': 'http://www.unica.fi/images/uploads/assari.jpg', 'lat': '60.4542999267578', 'lng': '22.2875003814697'},
               ...
               {'type': 'studentlunch', 'title':'Kåren', 'link': 'http://www.studentlunch.fi/se/lunchlistan/veckans-lista?id=3&year=' + str(year) +'&week=' + str(week), 'thumb': 'http://www.studentlunch.fi/assets/images/logos/restaurant_3.jpg', 'lat':'60.4496002197266', 'lng':'22.2754001617432'},
               {'type': 'studentlunch', 'title':'Fanriken', 'link':'http://www.studentlunch.fi/se/lunchlistan/veckans-lista?id=4&year=' + str(year) +'&week=' + str(week), 'thumb': 'http://www.studentlunch.fi/assets/images/logos/restaurant_4.jpg', 'lat': '60.456600189209', 'lng': '22.2826995849609'},
    ...
    def on_inline_query(self, msg):
        def compute_answer():
            ...
            articles = [{'type': 'article', 'id': 'assari', 'title': restaurants[0]['title'], 'thumb_url': restaurants[0]['thumb'], 'url': restaurants[0]['link'], 'message_text': restaurants[0]['title'] + ', ' + dayName[maxDateWSat] + ' :' + restaurantMenus[0][dayName[maxDateWSat]], 'latitude': restaurants[0]['lat']},
                        ...
                        {'type': 'article', 'id': 'arken', 'title': restaurants[3]['title'], 'thumb_url': restaurants[3]['thumb'], 'url': restaurants[3]['link'], 'message_text': restaurants[3]['title'] + ', ' + dayName[maxDateWOWknd] + ' :' + restaurantMenus[3][dayName[maxDateWOWknd]]},
                        {'type': 'article', 'id': 'karen', 'title': restaurants[4]['title'], 'thumb_url': restaurants[4]['thumb'], 'url': restaurants[4]['link'], 'message_text': restaurants[4]['title'] + ', ' + dayName[maxDateWOWknd] + ' :' + restaurantMenus[4][dayName[maxDateWOWknd]]},
                        #{'type': 'article', 'id': 'fanriken', 'title': restaurants[5]['title'], 'thumb_url': restaurants[5]['thumb'], 'url': restaurants[5]['link'], 'message_text': restaurants[5]['title']+ ', ' + dayName[maxDateWOWknd] + ' :' + restaurantMenus[5][dayName[maxDateWOWknd]]},
                        {'type': 'article', 'id': 'gado', 'title': restaurants[6]['title'], 'thumb_url': restaurants[6]['thumb'], 'url': restaurants[6]['link'], 'message_text': restaurants[6]['title'] + ', ' + dayName[maxDateWOWknd] + ' :' + restaurantMenus[6][dayName[maxDateWOWknd]]},
                        ]
            return articles
